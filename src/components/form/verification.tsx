...
const createInitialVerificationFormData = (sharedData: FormData | null): FormData => {
...
export function VerificationCollectorForm() {
  const posthog = usePostHog();
  const { sharedData, hasSharedData, setSharedData, clearSharedData } = useSharedFormData();
  const [formData, setFormData] = useState<FormData>(() => createInitialVerificationFormData(sharedData as FormData | null));
